...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，你来对地方了，来了就能让你发现谁该被避雷！',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '逆水寒避雷手册', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '也叫东南枝', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://h.163.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '逆水寒手游,避雷', // 网站关键词 英文逗号隔开
